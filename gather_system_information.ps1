...
Emkraan branded
- Dark HTML tabbed report
- Summary: CPU/Memory/Disk doughnuts + System details
- Performance: sampled data (CPU/Mem/Disk) with charts
- Printers trimmed
- Back to top button
- Added CPU speed, GPU memory, RAM type/speed (color-coded), Motherboard, Disk model/interface
#>
...
# RAM type+speed with color‑coding
$ramTypeLookup = @{
...
$cpuArr=($cpuSamples -join ",");$memArr=($memSamples -join ",");$diskArr=($diskSamples -join ",")
